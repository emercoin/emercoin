...
Requires:       pwgen openssl >= 1:1.0.2d libdb4 libdb4-cxx miniupnpc
...
%{__mkdir} -p $RPM_BUILD_ROOT%{_bindir} $RPM_BUILD_ROOT/etc/emercoin $RPM_BUILD_ROOT/etc/ssl/emc $RPM_BUILD_ROOT/var/lib/emc/.emercoin $RPM_BUILD_ROOT/usr/lib/systemd/system
