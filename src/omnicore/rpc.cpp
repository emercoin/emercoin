       ...
       "up a single token on tokenidstart can be specified only.\n",
       {
           ...
           {"tokenidend", RPCArg::Type::NUM, RPCArg::Optional::OMITTED, "the last non-fungible token in range"},
                   ...
                   RPCResult{
                       ...
                       "    \"owner\" : \"owner\",             (string) the Emercoin address of the owner\n"
       ...
       "\nGet the details for a fee distribution.\n",
       {
           {"distributionid", RPCArg::Type::NUM, RPCArg::Optional::NO, "(number, required) the distribution to obtain details for"},
                   ...
                   RPCResult{
                       ...
                       "    \"amount\" : nnn.nn,                 (string) the amount that was distributed\n"
                       "    \"recipients\" : [                   (array) a list of recipients\n"
                       "      {\n"
                       "        \"address\" : \"address\",        (string) the address\n"
                       "        \"amount\" nnn.nn,                (string) the amount of tokens in the range\n"
                       "      }...\n"
                       "    ]\n"
                       "  }...\n"
                       "]\n"
       ...
       "\nReturns the amount of fees required in the cache to trigger distribution.\n",
       {
           {"propertyid", RPCArg::Type::NUM, RPCArg::Optional::OMITTED, "filter the results on this property id"},
                   ...
                   RPCResult{
                       "[                                   (array of JSON objects)\n"
                       "  {\n"
                       "    \"propertyid\" : n,                  (number) the propertyid id\n"
                       "    \"feetrigger\" : nnn.nn,             (string) the amount of fees required to trigger distribution\n"
                       "  }...\n"
                       "]\n"
                   },
       RPCExamples{
       ...
       "\nReturns the percentage share of fees distribution applied to the wallet (default) or address (if supplied).\n",
       {
           ...
           {"ecosystem", RPCArg::Type::NUM, RPCArg::Optional::OMITTED, "the ecosystem to check the fee share (1 for main ecosystem, 2 for test ecosystem)"},
                   ...
                   RPCResult{
                       ...
                       "  {\n"
                       "    \"propertyid\" : n,                (number) the propertyid id\n"
                       "    \"feeshare\" : nnn.nn,             (string) the percentage of fees this address will receive based on current state\n"
                       "  }...\n"
                       "]\n"
                   },
       RPCExamples{
       ...
       "\nReturns the amount of fees cached for distribution.\n",
       {
           {"propertyid", RPCArg::Type::NUM, RPCArg::Optional::OMITTED, "filter the results on this property id"},
                   ...
                   RPCResult{
                       ...
                       "  {\n"
                       "    \"propertyid\" : n,                (number) the propertyid id\n"
                       "    \"cachedfees\" : nnn.nn,           (string) the amount of fees cached for this property\n"
                       "  }...\n"
                       "]\n"
                   },
       RPCExamples{
       ...
       "\nReturns details for about the tokens or smart property to lookup.\n",
       {
           {"propertyid", RPCArg::Type::NUM, RPCArg::Optional::NO, "the identifier of the tokens or property"},
                   ...
                   RPCResult{
                       ...
                       "  \"issuer\" : \"issuer\"                 (string) the Emercoin address of the issuer on record"
                       "  \"delegate\" : \"delegate\"             (string) the Bitcoin address of the issuance delegate, if there is one"
    ...
    RPCHelpMan{"omni_listproperties",
       ...
       {},
              RPCResult{
                   ...
                   "    \"issuer\" : \"address\",            (string) the Emercoin address of the issuer on record\n"
       ...
       "\nList active offers on the distributed token exchange.\n",
       {
           ...
           {"propertyiddesired", RPCArg::Type::NUM, RPCArg::Optional::OMITTED, "filter orders by property identifier desired"},
               ...
               RPCResult{
                   ...
                   "    \"txid\" :                (hexstr) the hex-encoded hash of the transaction of the order\n"
                   "    \"ecosystem\" :           (string) the ecosytem in which the order was made (if \"cancel-ecosystem\")\n"
                   "    \"propertyidforsale\" :   (number) the identifier of the tokens put up for sale\n"
                   "    \"propertyidforsaleisdivisible\" : (bool) whether the tokens for sale are divisible\n"
                   "    \"amountforsale\" :       (string) the amount of tokens initially offered\n"
                   "    \"amountremaining\" :     (string) the amount of tokens still up for sale\n"
                   "    \"propertyiddesired\" :   (number) the identifier of the tokens desired in exchange\n"
                   "    \"propertyiddesiredisdivisible\" : (bool) whether the desired tokens are divisible\n"
                   ...
                   "    \"action\" :              (number) the action of the transaction: (1) \"trade\", (2) \"cancel-price\", (3) \"cancel-pair\", (4) \"cancel-ecosystem\"\n"
                   "    \"block\" :               (number) the index of the block that contains the transaction\n"
                   "    \"blocktime\" :           (number) the timestamp of the block that contains the transaction\n"
                   "  },\n"
                   "  ...\n"
                   "]\n"
               },
...
static UniValue omni_gettradehistoryforaddress(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{"omni_gettradehistoryforaddress",
       ...
       RPCResult{
                   ...
                   "  {\n"
                   "    \"txid\" :                         (hexstr) the hex-encoded hash of the transaction of the order\n"
                   "    \"sendingaddress\" :               (string) the Bitcoin address of the trader\n"
                   "    \"ismine\" :                       (bool) whether the order involes an address in the wallet\n"
                   "    \"confirmations\" :                (number) the number of transaction confirmations\n"
                   "    \"fee\" :                          (string) the transaction fee in emercoins\n"
                   "    \"blocktime\" :                    (number) the timestamp of the block that contains the transaction\n"
                   "    \"valid\" :                        (bool) whether the transaction is valid\n"
                   "    \"version\" :                      (number) the transaction version\n"
                   "    \"type_int\" :                     (number) the transaction type as number\n"
                   ...
                   "    \"canceltxid\" :                   (hexstr) the hash of the transaction that cancelled the order (if cancelled)\n"
                   "    \"matches\": [                     (array of JSON objects) a list of matched orders and executed trades\n"
                   "    {\n"
                   "      \"txid\" (hexstr) the hash of the transaction that was matched against\n"
                   "      \"block\"  (number) the index of the block that contains this transaction\n"
                   "      \"address\" (string) the Bitcoin address of the other trader\n"
       ...
       "\nRetrieves the history of trades on the distributed token exchange for the specified market.\n",
       {
           ...
           {"count", RPCArg::Type::NUM, /* default */ "10", "number of trades to retrieve"},
                   ...
                   RPCResult{
                       ...
                       "  {\n"
                       "    \"propertyid\" : n\n"
                       "    \"block\" :           (number) the index of the block that contains the trade match\n"
                       ...
                       "    \"sellertxid\" :      (hexstr) the hash of the transaction of the seller\n"
                       "    \"address\" :         (string) the Bitcoin address of the seller\n"
                       "    \"amountsold\" :      (string) the number of tokens sold in this trade\n"
                       "    \"amountreceived\" :  (string) the number of tokens traded in exchange\n"
                       "    \"matchingtxid\" :    (hexstr) the hash of the transaction that was matched against\n"
...
static UniValue omni_getactivedexsells(const JSONRPCRequest& request)
{
       ...
       "\nReturns currently active offers on the distributed exchange.\n",
       {
           {"address", RPCArg::Type::STR, /* default */ "include any", "address filter"},
               ...
               RPCResult{
                   ...
                   "    \"seller\" : \"address\",               (string) the Emercoin address of the seller\n"
                   "    \"amountavailable\" : \"n.nnnnnnnn\",   (string) the number of tokens still listed for sale and currently available\n"
                   "    \"emercoindesired\" : \"n.nnnnnnnn\",    (string) the number of emercoins desired in exchange\n"
                   ...
                   "      {\n"
                   "        \"buyer\" : \"address\",                (string) the Emercoin address of the buyer\n"
                   ...
                   "        \"amounttopay\" : \"n.nnnnnnnn\"        (string) the amount in emercoins needed finalize the trade\n"
                   "      },\n"
                   "      ...\n"
                   "    ]\n"
                   "  },\n"
    ...
    for (OfferMap::iterator it = my_offers.begin(); it != my_offers.end(); ++it) {
        ...
        // calculate unit price and updated amount of emercoin desired
        ...
        if ((sellOfferAmount > 0) && (sellBitcoinDesired > 0)) {
            ...
            if (!isPropertyDivisible(propertyId)) {
                unitPriceFloat /= (double)COIN; // emercoin: precision 6 digits (1M)
                // unitPriceFloat /= 100000000.0;
            }
        }
        int64_t unitPrice = rounduint64(unitPriceFloat * COIN);
        int64_t emercoinDesired = calculateDesiredBTC(sellOfferAmount, sellBitcoinDesired, amountAvailable);
        ...
        responseObj.pushKV("emercoindesired", FormatDivisibleMP(emercoinDesired));
    ...
    RPCHelpMan{"omni_listblocktransactions",
       "\nLists all Omni transactions in a block.\n",
       {
           {"index", RPCArg::Type::NUM, RPCArg::Optional::NO, "the block height or block index"},
               ...
               RPCResult{
                   "[                       (array of string)\n"
                   "  \"hash\",             (hexstr) the hash of the transaction\n"
                   "  ...\n"
                   "]\n"
               },
      RPCExamples{
       ...
       "\nGet detailed information about an Omni transaction.\n",
       {
           {"txid", RPCArg::Type::STR, RPCArg::Optional::NO, "the hash of the transaction to lookup"},
               ...
               RPCResult{
                   ...
                   "  \"sendingaddress\" : \"address\",     (string) the Emercoin address of the sender\n"
                   "  \"referenceaddress\" : \"address\",   (string) a Emercoin address used as reference (if any)\n"
                   "  \"ismine\" : true|false,            (boolean) whether the transaction involes an address in the wallet\n"
                   "  \"confirmations\" : nnnnnnnnnn,     (number) the number of transaction confirmations\n"
                   "  \"fee\" : \"n.nnnnnnnn\",             (string) the transaction fee in emercoins\n"
    ...
    RPCHelpMan{"omni_getinfo",
       ...
       {},
               RPCResult{
                   ...
                   "  \"omnicoreversion\" : \"x.x.x.x-xxx\",     (string) Omnicore client version\n"
                   "  \"emercoincoreversion\" : \"x.x.x\",       (string) TODO: Emercoin Core version\n"
                   "  \"bitcoincoreversion\" : \"x.x.x\",        (string) Bitcoin Core (ENGINE) version\n"
       ...
       "\nGet information and recipients of a send-to-owners transaction.\n",
       {
           ...
           {"recipientfilter", RPCArg::Type::STR, /* default */ "\"*\" for all", "a filter for recipients"},
               ...
               RPCResult{
                   ...
                   "    {\n"
                   "      \"address\" : \"address\",          (string) the Emercoin address of the recipient\n"
       ...
       "The documentation only covers the output for a trade, but there are also cancel transactions with different properties.\n",
       {
           {"txid", RPCArg::Type::STR, RPCArg::Optional::NO, "the hash of the order to lookup"},
             ...
             RPCResult{
               ...
               "    \"sendingaddress\" : (string) the Bitcoin address of the trader\n"
               "    \"ismine\" : (bool) whether the order involes an address in the wallet\n"
               "    \"confirmations\" : (numeric) the number of transaction confirmations\n"
               "    \"fee\" : (string) the transaction fee in emercoins\n"
               "    \"blocktime\" : (numeric) the timestamp of the block that contains the transaction\n"
               "    \"valid\" : (bool) whether the transaction is valid\n"
               "    \"version\" : (numeric) the transaction version\n"
               "    \"type_int\" : (numeric) the transaction type as number\n"
               "    \"type\" : (string) the transaction type as string\n"
               "    \"propertyidforsale\" : (numeric) the identifier of the tokens put up for sale\n"
               "    \"propertyidforsaleisdivisible\" : (bool) whether the tokens for sale are divisible\n"
               "    \"amountforsale\" : (string) the amount of tokens initially offered\n"
               "    \"propertyiddesired\" : (numeric) the identifier of the tokens desired in exchange\n"
               "    \"propertyiddesiredisdivisible\" : (bool) whether the desired tokens are divisible\n"
               "    \"amountdesired\" : (string) the amount of tokens initially desired\n"
               "    \"unitprice\" : (string) the unit price (shown in the property desired)\n"
               "    \"status\" : (string) the status of the order (\"open\", \"cancelled\", \"filled\", ...)\n"
               "    \"canceltxid\" : (hexstr)the hash of the transaction that cancelled the order (if cancelled)\n"
               "    \"matches\" : (array of JSON) a list of matched orders and executed trade\n"
               "      {\n"
               "        \"txid\" : (hexstr) the hash of the transaction that was matched against\n"
               "        \"block\" : (numeric) the index of the block that contains this transaction\n"
               "        \"address\" : (string) the Bitcoin address of the other trader\n"
               "        \"amountsold\" : (string) the number of tokens sold in this trade\n"
               "        \"amountreceived\" : (string) the number of tokens traded in exchange\n"
               "      }...\n"
       ...
       "\nReturns a hash of the current state of the MetaDEx (default) or orderbook.\n",
       {
           {"propertyid", RPCArg::Type::NUM, RPCArg::Optional::OMITTED, "hash orderbook (only trades selling propertyid)"},
                   ...
                   RPCResult{
                       "[                           (array of JSON objects)\n"
                       "  {\n"
                       "    \"block\" : (numeric) the index of the block this hash applies to\n"
                       "    \"blockhash\" : (hexstr) the hash of the corresponding block\n"
                       "    \"propertyid\" : (numeric) the market this hash applies to (or 0 for all markets)\n"
                       "    \"metadexhash\" : (hexstr) the hash for the state of the MetaDEx/orderbook\n"
                       "  }...\n"
                       "]\n"
                   },
      RPCExamples{
